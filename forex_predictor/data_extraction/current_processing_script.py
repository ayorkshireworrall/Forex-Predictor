...
def process_raw_data_file(name, intervals, target_interval_minutes, market, input_minutes_missing_allowance, training_start_str, validation_start_str, test_start_str, test_end_str, dataframe_batch_size):
    set_name(name) 
...
market = 'EUR/GBP'
input_minutes_missing_allowance = 1
...
process_raw_data_file(name, intervals, target_interval_minutes, market, input_minutes_missing_allowance, training_start_str, validation_start_str, test_start_str, test_end_str, dataframe_batch_size)

name = 'test3' #Make sure name doesn't conflict with any existing files before running
intervals = [15, 10, 5, 5, 5, 5, 5, 5, 5]
target_interval_minutes = 60
market = 'EUR/GBP'
input_minutes_missing_allowance = 3
training_start_str = '2015-01-01 00:00:00'
validation_start_str = '2018-01-01 00:00:00'
test_start_str = '2019-01-01 00:00:00'
test_end_str = '2021-01-01 00:00:00'
...
name = 'test4' #Make sure name doesn't conflict with any existing files before running
intervals = [15, 10, 5, 5, 5, 5, 5, 5, 5]
target_interval_minutes = 40
market = 'EUR/GBP'
input_minutes_missing_allowance = 3
